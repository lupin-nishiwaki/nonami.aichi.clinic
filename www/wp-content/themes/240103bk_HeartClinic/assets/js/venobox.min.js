!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).VenoBox = t());
})(this, function () {
  "use strict";
  /**
   * VenoBox 2.0.4
  ...
  function ne(e) {
    if (Q) {
      ...
      (N = D - V),
        N < 0 && L && ((e = T), (t = !0)),
        N > 0 && w && ((e = j), (t = !0)),
        Math.abs(N) >= 50 && t ? le(e) : ((a.style.marginLeft = 0), (a.style.opacity = 1));
    }
  }
  function se(e) {
    if (Q && !y) {
  ...
  function de(l) {
    return (
      ...
      (l.settings.onPreOpen && "function" == typeof l.settings.onPreOpen && l.settings.onPreOpen(l),
      !!l.settings.onPreOpen &&
        ...
        void k.addEventListener("click", function (e) {
          ...
          t &&
            (t.contains(e.target) ||
              t === e.target ||
              (r.settings.overlayClose && e.target.classList.contains("vbox-overlay")) ||
